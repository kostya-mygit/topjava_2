...
- 2.5 Добавить валидацию для `Jdbc..Repository` через Bean Validation API (для JPA это делается автоматически при сохранении в базу. Для Jdbc мы должны это длеать вручную).  Оптимизировать код.
