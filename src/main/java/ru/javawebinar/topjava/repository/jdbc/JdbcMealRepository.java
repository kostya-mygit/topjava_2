...
public abstract class JdbcMealRepository implements MealRepository {
    ...
    public Meal save(Meal meal, int userId) {
        MapSqlParameterSource map = prepareMapSqlParameterSource(meal, userId);
    ...
    public abstract MapSqlParameterSource prepareMapSqlParameterSource(Meal meal, int userId);
}
